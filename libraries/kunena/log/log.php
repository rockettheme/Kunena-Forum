...
class KunenaLog
{
	...
	const LOG_POST_MOVE = 'LOG_POST_MOVE';
	...
	const LOG_TOPIC_MOVE = 'LOG_TOPIC_MOVE';
	const LOG_TOPIC_FORK = 'LOG_TOPIC_FORK';
	const LOG_TOPIC_SPLIT = 'LOG_TOPIC_SPLIT';
	const LOG_TOPIC_MERGE = 'LOG_TOPIC_MERGE';
	...
	{
		static::$entries[] = new KunenaLogEntry($type, $operation, $data, $user, $category, $topic);
	}
