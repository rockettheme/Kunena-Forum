...
<ul class="nav nav-list">
	...
	<li<?php if ($view == 'logs') echo ' class="active"';?>><a href="<?php echo JRoute::_('index.php?option=com_kunena&view=logs'); ?>"><i class="icon-search"></i> <?php echo JText::_('COM_KUNENA_LOG_MANAGER'); ?></a></li>
	<li<?php if ($view == 'statistics') echo ' class="active"';?>><a href="<?php echo JRoute::_('index.php?option=com_kunena&view=statistics'); ?>"><i class="icon-image"></i> <?php echo JText::_('COM_KUNENA_MENU_STATISTICS'); ?></a></li>
